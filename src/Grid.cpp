...
///
/// GridOpsTest.InterpolateDensityPeriodicAcceptsASmallCentredGridsOwnExtent
/// mirrors this count locally rather than importing it, because widening the
/// public surface for a test's benefit is the worse trade. The cost is that
